							...
							switch ($data['approvalstatus']){
								...
								case '2':
									if ($Trapproval->approver->isfinal == 1){
										...
										$red = 'Your Travel request has been approved';
					...
					table tr td { font-size:10px;}
												...
												*/
												...
												<tr>
													...
													<td style="border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="center" valign=bottom>MD</td>
													</tr>
												<tr>
								...
								try {
									...
									ob_clean();
									$fileName ='doc'.DS.'tr'.DS.'pdf'.DS.''.$Tr->employee->sapid.'_'.date("YmdHis").'.pdf';
