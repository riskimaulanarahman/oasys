(function (app) {
    app.register.controller('advexpensereportCtrl', ['$rootScope','$scope', '$http', '$interval','$location','CrudService','AuthenticationService','$filter', function($rootScope,$scope, $http, $interval,$location,CrudService,AuthenticationService,$filter)  {
        $scope.ds={};
        $scope.test=[];
        $scope.disabled= true;
        ...
        $scope.dataGridOptions = {
            ...
            columns: [{
                    ...
                    {dataField:'expenseno',caption:"Expense No",width: 200, editorOptions: { 
                        disabled: true,
                    }},
