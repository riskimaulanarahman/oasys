(function (app) {
    app.register.controller('advpaymentreportCtrl', ['$rootScope','$scope', '$http', '$interval','$location','CrudService','AuthenticationService','$filter', function($rootScope,$scope, $http, $interval,$location,CrudService,AuthenticationService,$filter)  {
        $scope.ds={};
        $scope.test=[];
        $scope.disabled= true;
        ...
        $scope.dataGridOptions = {
            ...
            columns: [{
                    ...
                    {dataField:'paymentno',caption:"Payment No",width: 200, editorOptions: { 
                        disabled: true,
                    }},
