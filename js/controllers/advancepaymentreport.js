(function (app) {
app.register.controller('advancepaymentreportCtrl', ['$rootScope','$scope', '$http', '$interval','$location','CrudService','AuthenticationService','$filter', function($rootScope,$scope, $http, $interval,$location,CrudService,AuthenticationService,$filter)  {
    $scope.ds={};
    $scope.test=[];
	$scope.disabled= true;
	...
	var myStore = new DevExpress.data.CustomStore({
		load: function() {			
            ...
            return CrudService.FindData('spkldetail',criteria).then(function (response) {
	...
	$scope.$on("initSPKLTMSReport", function(event, name) {
		initController();
		//$scope.dataGrid.refresh();
    });
    ...
    $scope.dataGridOptions = {
        ...
        columns: [
				...
				{dataField:'datework',caption: "Work Date",dataType:"date", format:"dd/MM/yyyy",width: 80},
				...
				{dataField:'reqby',caption: "Superintendent"},
				{dataField:'depthead',caption: "Dept Head"},
				{dataField:'actualstartwork',caption: "Start Work",dataType:"date", format:"dd/MM/yyyy HH:mm:ss",width: 80},
				{dataField:'actualendwork',caption: "End Work",dataType:"date", format:"dd/MM/yyyy HH:mm:ss",width: 80},
				{dataField:'actualtotalhours',caption: "Total Hours"},
				{dataField:'actualnormalhours',caption: "Normal Hours"},
				{dataField:'actualovertimehours',caption: "Overtime Hours"},
				{dataField:'descriptionofwork',caption: "Achievement"},
                ],	
        "export": {
            enabled: true,
            fileName: "ExportGrid",
